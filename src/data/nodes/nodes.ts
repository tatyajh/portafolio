...
export const NODES: Record<string, Node> = {
  ...
  herencia: {
    ...
    gallery: [...MEDIA.images.herencia, ...MEDIA.images.arte],
  ...
  quiebre: {
    ...
    content: 'Siempre pensé que era mala para el arte. En el colegio ni lo intentaba. Y si no mostraba interés, nadie se daba cuenta de que no me salía.\n\nMe quedé con lo que sí sabía hacer: la lógica, las respuestas correctas, las cosas que cierran. Y eso que crecí rodeada de arte y de costura.\n\nDespués pasaron varias cosas casi al tiempo. A mi papá le dio un accidente cerebrovascular. Yo vivía lejos de casa, hablando un idioma que todavía me costaba. Hay días en que uno no encuentra las palabras, ni en español ni en el otro idioma.\n\nAhí volví a hacer cosas con las manos. No fue un plan. Era la manera de decir lo que no me salía hablando. Y resulta que no era tan mala como yo creía.',
  ...
  mixto: {
    ...
    content: 'He hecho performances donde junto las dos cosas. Hago una parte de la coreo en el pole, me paro, cojo el saxofón y toco. Y todo va contando una historia.\n\nLa idea es que no se sienta como dos números aparte: el movimiento me lleva a la música, y la música me devuelve al pole.\n\nEstos videos son de esos momentos.',
  ...
  fin: {
    ...
    content: 'Si quieres hablar de un proyecto, de un juego o de lo que sea, escríbeme por donde te quede más fácil.',
